...
about: Transfer a subdomain from one GitHub user to another
title: "[TRANSFER] <subdomain>: from <old-user> to <new-user>"
labels: ownership-transfer
---

## Subdomain

- **Subdomain:** `name.made-in.app`

## Parties

- **Current owner (GitHub username):** `old-user`
- **New owner (GitHub username):** `new-user`
